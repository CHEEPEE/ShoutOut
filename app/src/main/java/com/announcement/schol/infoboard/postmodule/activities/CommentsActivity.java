...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                mDatabaseRef.updateChildren(childUpdate).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        sendComment.setEnabled(true);
                        Toast.makeText(CommentsActivity.this,"Comment Failed Check your Network",Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
        ...
        //Comments
        commentRecyclerViewAdapter = new CommentRecyclerViewAdapter(CommentsActivity.this,commentModelsArray);
